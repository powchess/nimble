...
const BN_LEN = 64;
const DIGIT_SIZE = 4;
export const BN_SIZE = BN_LEN * DIGIT_SIZE;
export const PT_SIZE = BN_LEN * 2 * DIGIT_SIZE;
...
export const getMemory = () => {
	memory = memory || new WebAssembly.Memory({ initial: MEMORY_PAGES });
	return memory;
};
...
export const getSecp256k1Exports = () => {
